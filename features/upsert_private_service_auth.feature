@UpsertPrivateServiceAuth
Feature: Upsert redirect endpoint for private mode with service auth
  ...
  Scenario: Upsert a redirect value via PUT without service auth
    Given redis is healthy
