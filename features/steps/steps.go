...
func (c *RedirectComponent) iShouldReceiveAnEmptyResponse() error {
	emptyResponse := &godog.DocString{Content: ""}
	return c.apiFeature.IShouldReceiveTheFollowingResponse(emptyResponse)
}

func (c *RedirectComponent) iShouldReceiveTheFollowingHealthJSONResponse(expectedResponse *godog.DocString) error {
...
func (c *RedirectComponent) validateHealthCheckResponse(healthResponse, expectedResponse HealthCheckTest) {
...
func (c *RedirectComponent) validateHealthVersion(versionResponse, expectedVersion healthcheck.VersionInfo, maxExpectedStartTime time.Time) {
...
func (c *RedirectComponent) validateHealthCheck(checkResponse, expectedCheck *Check) {
